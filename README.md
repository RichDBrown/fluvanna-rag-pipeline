...
The project demonstrates the basic RAG pipeline: **PDFs → Text Extraction → Chunking → Embedding → Query → Embedding → Top K Chunks → LLM Response**
...
* **Target Environment:** Python 3.14.7 or Later
